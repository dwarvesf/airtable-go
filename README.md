<a href="https://godoc.org/github.com/dwarvesf/airtable-go" ><img src="http://img.shields.io/badge/godoc-reference-5272B4.svg?style=flat-square" /></a>
...
```
go get github.com/dwarvesf/airtable-go
```
Import airtable-go into your project:

```go
import "github.com/dwarvesf/airtable-go"
```
...
import (
	"os"
	"github.com/dwarvesf/airtable-go"
)
